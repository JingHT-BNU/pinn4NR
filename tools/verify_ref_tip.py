...
用法:
    python tools/verify_ref_tip.py --labels train_0059,train_0164

输出:
    日志(paper/logs/tools/) + tools/refs/verify_tip/<label>_axis.npz
    (x/u32/u48 稠密轴) + tools/refs/verify_tip/summary.json
"""
