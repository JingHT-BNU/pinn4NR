...
tools/refs/ref_<label>.npz (与 reference_u.npz 同格式 + 谱系数)。
...
用法:
    python tools/make_refs_batch.py                 # 6 个代表配置
    python tools/make_refs_batch.py --force         # 覆盖已有文件
    python tools/make_refs_batch.py --n-r 384 --lmax 32   # 低分辨率(快)
"""
